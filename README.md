...
**Frontend & Full Stack Engineer** | Costa Rica

Building modern web applications with React, Next.js, TypeScript, and AI-powered integrations.

---

## About

I design and develop production-ready web platforms — from interactive real estate maps to full hospitality operating systems. My focus is on clean architecture, real-time features, and integrating AI services (OpenAI, Claude/Anthropic) into practical business solutions.

Currently working as a Software Engineer at [Dojo Coding Labs](https://github.com/DojoCodingLabs), building AI-native learning platforms and SaaS products using modern tooling including Claude Code for AI-assisted development workflows.
...
![Anthropic](https://img.shields.io/badge/Claude_/_Anthropic-191919?style=for-the-badge&logo=anthropic&logoColor=white)
